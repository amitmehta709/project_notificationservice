...
//    }
    ...
    public T deserialize(String topic,Headers headers, byte[] data) {
        ...
        Class<?> targetClass = switch (type) {
            case "RefundEvent" -> com.scaler.amit.project_notificationservice.RefundEvent.class;
            case "OrderCompletedEvent" -> com.scaler.amit.project_notificationservice.OrderCompletedEvent.class;
